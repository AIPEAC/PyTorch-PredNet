...
#TODO: MNIST - Function to extract and record all model parameters
...
#TODO: MNIST - Setup parameter tracking file (jsonl format, one record per line)
...
for epoch in range(num_epochs):
	...
	for step, (inputs, targets) in enumerate(train_loader):
		...
		#TODO: MNIST - Record all parameters after each batch to avoid memory accumulation
...
os.makedirs(data_compare_dir, exist_ok=True)
loss_history_file = 'transformer_mnist-' + model_name + '-loss_history-train.json'
