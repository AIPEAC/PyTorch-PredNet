...
#TODO: Borrow Weights - Load pre-trained weights from original PredNet (without transformer)
# Only load matching keys (Transformer weights and alpha_E0 will remain initialized)
pretrained_path = r's:\Projects\#ProjectNTU\branch2\transformer_mnist\models\prednet-L_all-mul-peepFalse-tbiasFalse-best.pt'
if os.path.exists(pretrained_path):
	...
	print('Pre-trained weights loaded successfully (Transformer weights initialized fresh).')
else:
